...
|------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|------------|--------|
| 1    | Alta       | Como cliente, quero acessar um dashboard no PowerBI contendo os dados de exportação para obter uma visão maior e mais rápida do panorama comercial de São Paulo sem precisar manipular bases brutas.                                                    | 3          | 1      |
...
| 3    | Alta       | Como cliente, quero visualizar a evolução histórica das exportações de SJC por categoria de produto, para monitorar a dependência de insumos externos e o crescimento industrial local.                                               | 8          | 2      |
| 4  | Alta      | Como cliente, quero comparar o saldo comercial entre diferentes municípios no período de 2021 a 2022 para identificar quais regiões apresentam maior resiliência econômica.                                                                                                           | 5        | 3    |
...
| 8   | Média      | Como Cliente, quero filtrar as exportações do vale do Paraíba por categoria de produto (NCM) e país de destino, para identificar padrões comerciais e oportunidades de mercado.                                                    | 8          | 3      |
